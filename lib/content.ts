export const siteContent = {
  ...
  chat: {
    ...
    mockResponses: {
      precios: "Nuestros precios varían según el proyecto. Una auditoría inicial cuesta desde $500 USD. Automatizaciones simples desde $1,500 USD. ¿Te interesa agendar una consulta gratuita?",
      implementación: "El proceso típico toma 2-8 semanas dependiendo de la complejidad. Incluye: análisis inicial, desarrollo, pruebas, capacitación y soporte. ¿Qué tipo de automatización te interesa?",
      tiempos: "Proyectos simples: 1-2 semanas. Proyectos complejos: 4-8 semanas. Siempre entregamos en fases para que veas progreso constante. ¿Tienes algún deadline específico?",
      soporte: "Incluimos 6 meses de soporte gratuito con todas nuestras implementaciones. Después ofrecemos planes de mantenimiento desde $200 USD/mes. ¿Necesitas soporte especializado?"
    }
  },
