...
import { Workflow, Settings, Zap, Database, CheckCircle, Clock, Shield } from 'lucide-react';
...
export default function ProcesosPage() {
  ...
  const processData = solutions.items.find(item => item.id === 'procesos');

  const handleWhatsApp = () => {
    const message = encodeURIComponent("Hola, quiero más información sobre Organización de Procesos Internos");
  ...
  const processSteps = [
    {
      ...
      description: "Analizamos tus operaciones actuales para identificar ineficiencias, bottlenecks y oportunidades de automatización."
    },
    {
      icon: Settings,
      title: "Diseño de Orquestación n8n",
      description: "Creamos flujos de trabajo visuales en n8n que conectan tus herramientas y sistemas existentes sin código."
    },
    {
      icon: Database,
      title: "Integración de Sistemas",
      description: "Conectamos APIs, bases de datos y aplicaciones para un flujo de datos seamless entre todos tus sistemas."
    },
    {
      icon: Zap,
      title: "Optimización y Escalabilidad",
      description: "Implementamos monitoreo continuo y escalamos los procesos para manejar mayor volumen sin costos adicionales."
    }
  ];

  const benefits = [
    "Reducción del 50% en tareas manuales repetitivas",
    "Disminución del 90% en errores humanos",
    "Aceleración de procesos en un 3x",
    "ROI visible en los primeros 60 días de operación"
  ];

  const faqs = [
    {
      question: "¿Qué es n8n y por qué lo usamos?",
      answer: "n8n es una herramienta de automatización open-source que permite crear workflows complejos visualmente. Es segura, escalable y se integra con 200+ aplicaciones sin vendor lock-in."
    },
    {
      question: "¿Cuánto tiempo toma implementar?",
      answer: "Procesos simples: 3-5 semanas. Orquestaciones complejas con múltiples integraciones: 8-12 semanas. Trabajamos en fases para minimizar disrupción."
    },
    {
      question: "¿Se integra con mis sistemas actuales?",
      answer: "Sí, n8n se conecta con prácticamente cualquier herramienta: CRMs (Salesforce, HubSpot), email (Gmail, Outlook), bases de datos, APIs custom y más."
    },
    {
      question: "¿Requiere mantenimiento constante?",
      answer: "No. Una vez implementado, n8n corre de forma autónoma. Incluimos monitoreo proactivo y actualizaciones trimestrales en el primer año."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              {processData?.subtitle || "Orquestación n8n"}
            </p>
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Desde $2,000 USD | Implementación en 6-10 semanas
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Las piezas clave que transforman tus operaciones
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {processData?.bullets?.map((bullet, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                <Card className="bg-brand-800/30 border-brand-600/20 backdrop-blur-sm hover:bg-brand-800/50 transition-all duration-300 h-full rounded-2xl">
                  ...
                  <CardContent>
                    <p className="text-white/70 leading-relaxed">
                      {index === 0 ? "Flujos de trabajo complejos automatizados con lógica condicional y bucles inteligentes." :
                       index === 1 ? "Conexiones seguras entre sistemas legacy y herramientas modernas sin reescritura de código." :
                       "Monitoreo en tiempo real y optimización continua de tus operaciones internas."}
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
